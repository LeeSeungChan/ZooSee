...
<body>
	<form  id="reviewForm"action="interceptor_tradeInfo_inputReview.do">
		...
		<div class="BJReplyInput" >
			<h2 style="margin-left: 13%;">${param.id}님에 대한 후기를 작성해주세요~!</h2><hr>
			...
			<table>
				<tr>
					<td>
						<textarea id="textConent" style="resize:none;margin-left: 17%;" class="BJform-controlBig2 input-lg" name="content" rows="3" cols="60"  ></textarea>
					</td>
