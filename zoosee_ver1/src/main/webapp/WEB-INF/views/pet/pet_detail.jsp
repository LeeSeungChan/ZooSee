	...
	<div class="WJcontainer7">
		...
		<div style="float: left; width: 50%;">
			...
			<div style="margin: 0 auto; width: 400px; height: 400px;">
				<img style="border: 1px solid black;" src="${initParam.root}${petVO.petImg}"
		...
		<div style="float: right; width: 50%;">
			...
			<input class="WJform-control" id="petName" name="petName" type="text" value="${petVO.petName}"
				readonly="readonly" style="background-color: #F4F4F4;"> 
			<label>Pet Age</label> 
			<input class="WJform-control" id="petAge" name="petAge" type="text" value="${petVO.petAge}" 
				readonly="readonly" style="background-color: #F4F4F4"> 
			<label>Pet Type</label> 
			<input class="WJform-control" id="petType" name="petType" type="text" value="${petVO.petType}" 
				readonly="readonly" style="background-color: #F4F4F4"> 
			<label>Pet Gender</label>
				<div class="radio" align="center">
					<label class="radio-inline"> 
						<input type="radio" name="petGender" value="man" disabled="disabled">MAN
					</label> 
					<label class="radio-inline"> 
						<input type="radio" name="petGender" value="woman" disabled="disabled">WOMAN
					</label>
			</div>
			<label>Pet Neutral</label>
			<div class="radio" align="center">
				<label class="radio-inline"> 
					<input type="radio" name="petNeutral" value="yes" disabled="disabled">Yes
				</label> 
				<label class="radio-inline"> 
					<input type="radio" name="petNeutral" value="no" disabled="disabled">No
				</label>
			</div>
			<label>Pet Size</label> 
			<input class="WJform-control" id="petSize" name="petSize" type="text" value="${petVO.petSize}"
				readonly="readonly" style="background-color: #F4F4F4"> 
			<label>Etc</label>
			<textarea class="WJform-control2" id="petEtc" name="etc" rows="3" style="width: 100%; resize: none; 
				background-color: #F4F4F4" readonly="readonly">${petVO.etc}</textarea><br> 
