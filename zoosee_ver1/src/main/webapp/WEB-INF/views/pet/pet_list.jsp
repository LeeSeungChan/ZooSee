...
<div class="BJMainDiv" style="margin-bottom: 10%;">
	<div class="BJPanel" style="width: 80%; margin-left: 10%;">
		<div class="panel panel-primary">
			...
			<div class="panel-body">${mvo.name }님의등록된 반려동물을 보여 드리기 위한
				공간입니다.</div>
		</div>
		<div class="well well-sm">${mvo.name }님이등록하신 반려동물 목록</div>
	</div>
					...
					<c:otherwise>
						<table class="table table-striped table-hover" style="width: 100%">
							...
							<c:forEach items="${list }" var="L">
								<tr>
									<td><img src="${L.petImg}" width="70" height="70"
										style="border-radius: 100px; -moz-border-radius: 100px; -khtml-border-radius: 100px; -webkit-border-radius: 100px;"></td>
									...
									<td style="vertical-align: middle;"><a
										href="${initParam.root}interceptor_pet_detail.do?petNo=${L.petNo}">상세보기</a><br>
										<a
										href="${initParam.root}interceptor_pet_update.do?petNo=${L.petNo}">수정하기</a><br>
										<a id="delete"
										href="${initParam.root}interceptor_pet_delete.do?petNo=${L.petNo}">삭제하기</a>
									</td>
								</tr>
							</c:forEach>
						</table>
